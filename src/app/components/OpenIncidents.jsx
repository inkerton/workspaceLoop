...
import { Modal, Box, Typography, Card, CardContent, Grid, Button, MenuItem, ListItemIcon, TextField } from '@mui/material';
      ...
      <Modal
        ...
        >
            ...
            <Typography variant="h6" id="change-status-modal-description">
                Change status of <span style={{ color: '#12a1c0', fontWeight: 'bold' }}> {incidentNo}  </span>
            </Typography>

                <Grid container spacing={2}>
                    {/* status */}
                    <Grid item xs={12}>
                        <Box className="flex" sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 2, mt: 2 }}>
